<?php
 ...
 $p      = new Paging;
                ...
                $no = $posisi+1;
                $jumlah = mysql_num_rows(mysql_query("select * from sentitems"));
...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h2>Tabel SMS Terkirim</h2></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                         <a href="<?php echo $basedx; ?>clear_history" onclick="return confirm('Apakah anda yakin akan menghapus history pengiriman sms ?')"><button class="btn btn-success" id="btn_add_admin" data-toggle="modal" data-target="#myModal">Hapus History Pengiriman <i class="icon-plus icon-white"></i></button></a>
                                      </div>
               ...
               <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable" id="example">
                ...
                <tbody id="tb_admin">
                <?php
				$q = mysql_query("select * from sentitems order by SendingDateTime desc limit $posisi,$batas ");
