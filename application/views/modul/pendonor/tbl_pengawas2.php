...
<div class="row-fluid">
               ...
               <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable" id="example">
                ...
                <td class="baris_admin_alamat" id="baris_admin_alamat_<?php echo $id; ?>"><?php echo $row->alamat; ?><div style="display:none;"><?php echo $kc.$ds; ?></div></td>
                
                <td class="baris_admin_tps" id="baris_admin_tps_<?php echo $id; ?>"><?php echo $tsp; // $tpsx;  ?></td>
