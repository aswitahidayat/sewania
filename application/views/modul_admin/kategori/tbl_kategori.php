				...
				?>
						...
						<br>
							...
							<div class="tab-content">
								...
								?>
								<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('sindrom/tambah_kategori'); ?>" method="post">
									<fieldset>
										...
										<div class="control-group">											
                                         ...
                                         <div class="control-group">											
											<label class="control-label" for="username">Icon</label>
											<div class="controls">
												<input type="file" name="f_upload" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
