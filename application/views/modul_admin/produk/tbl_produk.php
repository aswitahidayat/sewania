	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">      		
				...
				$pr = mysql_fetch_array(mysql_query("select * from sub_kategori where id_sub_kategori = '$row->id_sub_kategori'"));
				$rx = mysql_fetch_array(mysql_query("select * from kategori where id_kategori = '$pr[id_kategori]'"));
				$rp = mysql_fetch_array(mysql_query("select * from member where token_id = '$row->id_member'"));
				?>
                <tr class="baris_admin_btn" id="baris_admin_btn_<?php echo $id; ?>">
                <td><?php echo $no; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $row->nama_produk; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $row->harga; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $rx[1]; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $pr[1]; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $rp[1]; ?></td>
                <td class="baris_admin_username" id="baris_admin_nama_<?php echo $id; ?>"><?php echo $row->tanggal; ?></td>
