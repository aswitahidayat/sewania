...
<link href="../modul/css/bootstrap-responsive.min.css" rel="stylesheet">
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
<link href="../modul/css/font-awesome.css" rel="stylesheet">
<link href="../modul/css/style.css" rel="stylesheet">
<link href="../modul/css/pages/dashboard.css" rel="stylesheet">
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="../modul/index.html">Bootstrap Admin Template </a>
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="../modul/index.html"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        <li><a href="../modul/reports.html"><i class="icon-list-alt"></i><span>Reports</span> </a> </li>
        <li><a href="../modul/guidely.html"><i class="icon-facetime-video"></i><span>App Tour</span> </a></li>
        <li><a href="../modul/charts.html"><i class="icon-bar-chart"></i><span>Charts</span> </a> </li>
        <li><a href="../modul/shortcodes.html"><i class="icon-code"></i><span>Shortcodes</span> </a> </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Drops</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="../modul/icons.html">Icons</a></li>
            <li><a href="../modul/faq.html">FAQ</a></li>
            <li><a href="../modul/pricing.html">Pricing Plans</a></li>
            <li><a href="../modul/login.html">Login</a></li>
            <li><a href="../modul/signup.html">Signup</a></li>
            <li><a href="../modul/error.html">404</a></li>
          </ul>
        </li>
      </ul>
    </div>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="../modul/img/message_avatar1.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="../modul/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="../modul/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
...
<script src="../modul/js/jquery-1.7.2.min.js"></script> 
<script src="../modul/js/excanvas.min.js"></script> 
<script src="../modul/js/chart.min.js" type="text/javascript"></script> 
<script src="../modul/js/bootstrap.js"></script>
<script language="javascript" type="text/javascript" src="../modul/js/full-calendar/fullcalendar.min.js"></script>
 
<script src="../modul/js/base.js"></script> 
<script>     
