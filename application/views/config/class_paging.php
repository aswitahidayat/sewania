...
//$url = str_replace('akdjlsjadkjsa221998990.php' , '' , $url);
...
$link_halaman = "";
$url = str_replace('akdjlsjadkjsa221998990.php/' , '' , $_SERVER['PHP_SELF']);
// Link ke halaman pertama (first) dan sebelumnya (prev)
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	
	$link_halaman .= "<a href=$url?module=$_GET[module]&halaman=1 class='nextprev'>Awal</a>
                    <a href=$url?module=$_GET[module]&halaman=$prev class='nextprev'>Kembali</a>";
}
else{ 
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$url?module=$_GET[module]&halaman=$i>$i</a>";
  }
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "  <span class='nextprev'>...</span><a href=$url?module=$_GET[module]&halaman=$jmlhalaman>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	...
	$link_halaman .= " <a href=$url?module=$_GET[module]&halaman=$next class='nextprev'>Lanjut</a>
                     <a href=$url?module=$_GET[module]&halaman=$jmlhalaman class='nextprev'>Akhir</a> ";
}
else{
