<div class="panel-heading" style="border-bottom:3px solid #999999;">
                  <h4 class="panel-title"> <a href="#collapseB1"  data-toggle="collapse"> Produk Details </a> </h4>
                </div>
            ...
            <div class="adds-wrapper">
              <div class="tab-content">
				...
				///echo $_SESSION[member_id];
				 $prod = mysql_query("select * from produk where id_member = '$_SESSION[member_id]'");
