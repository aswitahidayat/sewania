    ...
    <div class="category-list">
        ...
        <div class="tab-box "> 
            ...
            <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                <li class="active"><a href="#allAds" data-url="<?php echo base_url('front/ajax_tab_2'); ?>" role="tab" data-toggle="tab">
                    All Ads 
                    <span class="badge">228,705</span>
                </li>
            </ul>
        ...
        <div class="tab-box  save-search-bar text-center">
            <a href="">
                <i class=" icon-star-empty"></i> Save Search 
            </a> 
        </div>
    </div>
