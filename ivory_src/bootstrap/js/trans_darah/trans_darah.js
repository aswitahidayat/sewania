...
jQuery('#btn_submit_admin').click(function(){
		...
		var idx = jQuery('#aksi_admin_form').val();
                 ...
                 var username = jQuery('#id_input').val();
				  
				 // var post_form = "user="+username+"&password="+password+"&email="+serial;
				 if(jQuery('#act_input').val() == 'ubah'){
				   var post_form = "id_input="+username+"&gol_input="+jQuery('#gol_input').val()+"&status_input="+jQuery('#status_input').val()+"&status_input="+jQuery('#status_input').val()+"&act=ubah";
				 }
				 else{
					var post_form = "id_input="+username+"&gol_input="+jQuery('#gol_input').val()+"&status_input="+jQuery('#status_input').val()+"&tanggal_input="+jQuery('#tanggal_input').val()+"&act="+"&nama_tempat2="+jQuery('#nama_tempat2').val()+"&alamat_donor2="+jQuery('#alamat_donor2').val(); 
				 }
